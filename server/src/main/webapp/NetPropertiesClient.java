 ...
 */
public class NetPropertiesClient {

	private final static Logger LOGGER = Logger.getLogger(NetPropertiesClient.class);
	...
	public NetPropertiesClient(String operation, String propertyName, String propertyValue, String sgid) {
		this(operation, propertyName, sgid);
		this.propertyValue = propertyValue;
	}

	public NetPropertiesClient(String operation, String propertyName, String sgid) {
